...
commute_filter = paste(
  "B08301", str_pad(c(2, 10, 18), 3, "left", "0"), sep = "_"
)
mass_commute %>%
...
mass_counties$pct_drive = 
  100 * mass_counties$B08301_002E / mass_counties$B08301_001E
mass_counties$pct_transit = 
  100 * mass_counties$B08301_010E / mass_counties$B08301_001E
mass_counties$pct_bike = 
  100 * mass_counties$B08301_016E / mass_counties$B08301_001E

tm_shape(mass_counties) +
  tm_polygons(
    c("pct_drive", "pct_transit"),
    title = c("Percent Car Commuters", "Percent Transit Commuters")
  )
